...
export class NftMarketplace1719171297707 implements MigrationInterface {
    name = 'NftMarketplace1719171297707'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`list_nft\` (\`id\` int NOT NULL AUTO_INCREMENT, \`is_delete\` tinyint NOT NULL DEFAULT 0, \`created_date\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`modified_date\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`price\` int NOT NULL DEFAULT 0, \`is_list\` tinyint NOT NULL DEFAULT 0, \`trending\` int NULL, \`nft_id\` int NULL, UNIQUE INDEX \`REL_f8214e799c7085467174e484ad\` (\`nft_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
